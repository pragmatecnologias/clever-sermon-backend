...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        function JwtAuthGuard_1() {
            ...
            _this.scriptureProtectedRoutes = new Set([
                'passage',
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            ...
            var path = (request === null || request === void 0 ? void 0 : request.path) || '';
            if ((request === null || request === void 0 ? void 0 : request.method) === 'GET' && path.startsWith('/api/v1/scripture/')) {
                var tail = path.replace('/api/v1/scripture/', '');
                var isSingleSegment = tail.length > 0 && !tail.includes('/');
