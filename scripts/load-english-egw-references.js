"use strict";
/**
 * Load English EGW Bible References
 * Loads English Bible references into the database
 */
...
function loadEnglishReferences() {
    return __awaiter(this, void 0, void 0, function () {
        var refsPath, paragraphsWithRefs, paragraphs, paragraphMap, _i, paragraphs_1, para, inserted, skipped, _a, paragraphsWithRefs_1, para, paragraphId, _b, _c, ref, totalCount, spanishCount, englishCount;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    refsPath = path.join(__dirname, '../data/egw-parsed-english/paragraphs-with-references.json');
                    if (!fs.existsSync(refsPath)) {
                        console.error('❌ English references file not found');
                        process.exit(1);
                    }
                    console.log('📖 Loading paragraphs with references...');
                    paragraphsWithRefs = JSON.parse(fs.readFileSync(refsPath, 'utf8'));
                ...
                case 2:
                    ...
                    for (_i = 0, paragraphs_1 = paragraphs; _i < paragraphs_1.length; _i++) {
                        para = paragraphs_1[_i];
                        paragraphMap.set(para.reference, para.id);
                    }
                    console.log("\u2705 Found ".concat(paragraphs.length, " English paragraphs in database"));
                    console.log('🗑️  Clearing existing English references...');
                ...
                case 3:
                    ...
                    inserted = 0;
                    skipped = 0;
                    _a = 0, paragraphsWithRefs_1 = paragraphsWithRefs;
                    _d.label = 4;
                case 4:
                    if (!(_a < paragraphsWithRefs_1.length)) return [3 /*break*/, 9];
                    para = paragraphsWithRefs_1[_a];
                    paragraphId = paragraphMap.get(para.reference);
                    if (!paragraphId) {
                        skipped++;
                        return [3 /*break*/, 8];
                    }
                ...
                case 6:
                    ...
                    inserted++;
                    if (inserted % 1000 === 0) {
                        console.log("\u2705 Inserted ".concat(inserted, " references..."));
                    }
                    _d.label = 7;
                case 7:
                    _b++;
                ...
                case 9:
                    ...
                    console.log("\u2705 Total English references inserted: ".concat(inserted));
                ...
                case 11:
                    spanishCount = _d.sent();
                    return [4 /*yield*/, dataSource.query("SELECT COUNT(*) as count FROM egw_scripture_references WHERE language = 'en'")];
                case 12:
                    englishCount = _d.sent();
                    console.log("\uD83D\uDCCA Total references in database: ".concat(totalCount[0].count));
...
loadEnglishReferences().catch(console.error);
