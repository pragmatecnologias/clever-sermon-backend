...
function loadSpanishParagraphs() {
    return __awaiter(this, void 0, void 0, function () {
        var paragraphsPath, paragraphs, inserted, batchSize, i, batch, _i, batch_1, para, totalCount, spanishCount, englishCount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    paragraphsPath = path.join(__dirname, '../data/egw-parsed-spanish/paragraphs.json');
                ...
                case 1:
                    ...
                    return [4 /*yield*/, dataSource.query("DELETE FROM egw_paragraphs WHERE language = 'es'")];
                case 2:
                    _a.sent();
                    ...
                    _a.label = 3;
                case 3:
                    if (!(i < paragraphs.length)) return [3 /*break*/, 9];
                ...
                case 6:
                    ...
                    return [3 /*break*/, 4];
                case 7:
                    console.log("\u2705 Inserted ".concat(inserted, " paragraphs..."));
                    _a.label = 8;
                case 8:
                    i += batchSize;
                    return [3 /*break*/, 3];
                case 9:
                    ...
                    console.log("\u2705 Total Spanish paragraphs inserted: ".concat(inserted));
                ...
                case 11:
                    ...
                    return [4 /*yield*/, dataSource.query("SELECT COUNT(*) as count FROM egw_paragraphs WHERE language = 'en'")];
                case 12:
                    englishCount = _a.sent();
                    console.log("\uD83D\uDCCA Total paragraphs in database: ".concat(totalCount[0].count));
