...
function loadSpanishReferences() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    refsPath = path.join(__dirname, '../data/egw-parsed-spanish/paragraphs-with-references.json');
                ...
                case 2:
                    ...
                    console.log("\u2705 Found ".concat(paragraphs.length, " Spanish paragraphs in database"));
                    console.log('🗑️  Clearing existing Spanish references...');
                    return [4 /*yield*/, dataSource.query("DELETE FROM egw_scripture_references WHERE language = 'es'")];
                case 3:
                    _d.sent();
                ...
                case 9:
                    ...
                    console.log("\u2705 Total Spanish references inserted: ".concat(inserted));
