...
var outputPath = process.argv[2] || 'data/book-metadata.json';
var url = 'https://raw.githubusercontent.com/jpoehls/bible-metadata/master/Books.csv';
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var resolvedOutput, tempPath, content, lines, rows, data, _i, rows_1, row, _a, bookId, osisId, bookName, totalChapters, volume, key;
        ...
        switch (_b.label) {
            ...
            case 3:
                ...
                for (_i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
                    row = rows_1[_i];
                    _a = row.split(','), bookId = _a[0], osisId = _a[1], bookName = _a[2], totalChapters = _a[3], volume = _a[4];
                    if (!bookName)
                        continue;
                    key = normalizeKey(bookName);
                    data[key] = {
                        id: Number(bookId),
                        osisId: osisId,
                        name: bookName,
            ...
            case 5:
                _b.sent();
                console.log("Saved ".concat(Object.keys(data).length, " book metadata entries to ").concat(resolvedOutput));
                return [2 /*return*/];
        }
    });
}); })();
