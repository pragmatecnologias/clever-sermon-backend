...
var _loop_1 = function (row) {
    ...
    data[key] = {
        ...
        verses: entry.verses ? entry.verses.split(';').map(function (value) { return value.trim(); }).filter(Boolean) : [],
    };
};
...
console.log("Wrote ".concat(Object.keys(data).length, " word occurrence entries to ").concat(outputPath));
