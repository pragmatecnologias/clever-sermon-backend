...
async function loadEnglishReferences() {
  const refsPath = path.join(__dirname, '../data/egw-parsed-english/paragraphs-with-references.json');
  ...
  console.log(`✅ Found ${paragraphs.length} English paragraphs in database`);
  ...
  console.log(`✅ Total English references inserted: ${inserted}`);
